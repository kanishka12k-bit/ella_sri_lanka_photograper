...
============================================================ */
document.addEventListener('DOMContentLoaded', function () {
  const track = document.getElementById('flagsTickerTrack');
  if (!track) return;
  ...
  function buildFlagItem(country) {
    const item = document.createElement('div');
    item.className = 'flag-item';

    const flagWrap = document.createElement('div');
    flagWrap.className = 'flag-item-flag';

    const img = document.createElement('img');
    img.src = `https://flagcdn.com/w80/${country.code}.png`;
    img.srcset = `https://flagcdn.com/w160/${country.code}.png 2x`;
  ...
  COUNTRIES.forEach(country => fragment.appendChild(buildFlagItem(country)));
